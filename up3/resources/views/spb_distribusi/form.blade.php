            ...
            <form  id="form-item" method="post" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data" >
                ...
                <div class="modal-body">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label >Total</label>
                            <input type="text" class="form-control" id="total_spb_dist" name="total_spb_dist" required>
                            <span class="help-block with-errors"></span>
                        </div>

                        <div class="form-group">
                            <label >Tanggal</label>
                            <input data-date-format='yyyy-mm-dd' type="date" class="form-control" id="tanggal_spb_dist" name="tanggal_spb_dist"   required>
                            <span class="help-block with-errors"></span>
                        </div>
