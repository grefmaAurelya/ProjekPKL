...
{{--<title>Material Distribusi export PDF</title>--}}
{{--</head>--}}
{{--<body>--}}
<style>
    #distribusies {
...
<h1 class="center">DAFTAR MATERIAL DISTRIBUSI</h1>
<table id="distribusies" width="100%">
    ...
    @foreach($distribusies as $c)
        ...
        <tr>
            ...
            <td>{{ $c->harga_satuan_dist}}</td>
            <td>{{ $c->asuransi_dan_transportasi_dist}}</td>
