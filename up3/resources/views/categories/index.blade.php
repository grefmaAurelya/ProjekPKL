...
@section('content')
    <div class="box">
        ...
        <div class="box-header">
            <a onclick="addForm()" class="btn btn-primary" >Tambah Laporan</a>
        ...
        <div class="box-body">
            <table id="invoice" class="table table-striped">
                ...
                @foreach($categories as $i)
                    ...
                    <td>
                        <a href="{{ route('exportPDF.categories', [ 'id' => $i->id ]) }}" class="btn btn-sm btn-danger">Export PDF</a>
                    </td>
                    </tbody>
                @endforeach
            </table>
...
@section('bot')
    ...
    <script type="text/javascript">
        ...
        function addForm() {
            ...
            $('.modal-title').text('Tambah Master Laporan');
        }
        ...
        function editForm(id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    $('#modal-form').modal('show');
                    $('.modal-title').text('Ubah Master Laporan');
